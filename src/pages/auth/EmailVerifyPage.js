        ...
        <div className="auth-card" style={{ textAlign: "center" }}>
          ...
          >
            <svg
              ...
              viewBox="0 0 24 24"
              fill="none"
              stroke="var(--color-primary, #b2b9ff"
              strokeWidth="2"
              strokeLinecap="round"
            >
          ...
          <h2 style={{ color: "var(--text-primary, #fff)" }}>인증 확인 중...</h2>
          <p style={{ color: "var(--text-secondary, #8f94a1)" }}>잠시만 기다려주세요.</p>
        </div>
    ...
    return (
      <div className="auth-page">
        ...
        <div className="auth-card" style={{ textAlign: "center" }}>
          ...
          <h2 style={{ color: "var(--text-primary, #fff)", marginBottom: 8 }}>인증 완료!</h2>
          <p style={{ color: "var(--text-secondary, #8f94a1)", fontSize: 14 }}>
          ...
          <button
            ...
            style={{ marginTop: 16, backgroundColor: "var(--color-success, #4ade80)", color: "#000" }}
  ...
  return (
    <div className="auth-page">
      ...
      <div className="auth-card" style={{ textAlign: "center" }}>
        ...
        <h2 style={{ color: "var(--text-primary, #fff)", marginBottom: 8 }}>인증 실패</h2>
        <p style={{ color: "var(--color-danger, #fca5a5)", fontSize: 14 }}>{message}</p>
        <button
          className="auth-submit-btn"
          style={{ marginTop: 24 }}
